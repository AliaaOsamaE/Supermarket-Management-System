...
namespace SuperMarketSystem
{
    public partial class FormGradingEmployees : Form
    {
        ...
        public FormGradingEmployees()
        {
            ...
            comboBox2.Items.AddRange(new string[] { "Top", "Average", "Poor" , "Good"});
        }

        private void FormGradingEmployees_Load(object sender, EventArgs e)
        {
        ...
        private void FormGradingEmployees_FormClosing(object sender, FormClosingEventArgs e)
        {
            conn.Dispose();
        }
